...
type ServiceType = (typeof servicesPageData.content)[number];
    ...
    <div className="min-h-screen py-32 px-4 sm:px-8">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24 pt-12">
          ...
          >
            <h2
              className={cn("text-2xl font-bold mb-6", service.color?.accent)}
            >
              {servicesPageData.labels.keyBenefits}
            </h2>
            <ul className="space-y-4">
              {(service.details?.benefits || service.features)?.map(
                (benefit) => (
                  <li key={benefit} className="flex gap-3 text-lg items-start">
                    <CheckCircle2
                      className={cn(
          ...
          >
            <h2 className="text-2xl font-bold mb-6">
              {servicesPageData.labels.howItWorks}
            </h2>
                ...
                <div key={step} className="flex gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-lg">
                      {servicesPageData.labels.step} {i + 1}
                    </p>
